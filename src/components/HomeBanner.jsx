      ...
      >
        ...
        <div className={styles.ctaContainer}>
          <div className={styles.ctaCard}>
            <div>
              <p className={styles.subtitle}>CARZONE JF</p>
              <h3 className={styles.title}>Frota de última geração. Dirija já
              </h3>
              <p className={styles.description}>Alugue o carro dos seus sonhos. Preço transparente, reserve em segundos</p>
            </div>
